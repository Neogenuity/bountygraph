...
import { BOUNTYGRAPH_IDL, BOUNTYGRAPH_PROGRAM_ID } from "../../sdk/src";
...
async function main() {
  ...
  const programId = BOUNTYGRAPH_PROGRAM_ID;
  const program = new anchor.Program(BOUNTYGRAPH_IDL, programId, provider);
